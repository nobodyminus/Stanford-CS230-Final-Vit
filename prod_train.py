...
def get_dataloaders(batch_size):
    ...
    valid_data = load_dataset('imagenet-1k', split='validation')
    test_data = load_dataset('imagenet-1k', split='test')
    ...
    test_data = ImagenetFromHuggingFace(test_data, test_transforms)
...
if __name__ == '__main__':
    ...
    #print('MESSAGE')
    #train_loader, valid_loader, test_loader = get_dataloaders(args.batch_size)
    #train(message_vit, train_loader, valid_loader, test_loader, args.device, args.lr, args.epochs)
